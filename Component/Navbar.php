<nav class="relative px-4 py-4 flex justify-between items-center bg-white">
    ...
    <ul
        ...
        <li><a class="text-sm text-gray-600 hover:text-gray-500" href="#">Home</a></li>
        ...
        <li><a class="text-sm text-gray-600 hover:text-gray-500" href="#">Services</a></li>
        <li class="text-gray-300">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill"
                viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <li><a class="text-sm text-gray-600 hover:text-gray-500" href="#">Pricing</a></li>
        <li class="text-gray-300">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill"
                viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <li><a class="text-sm text-gray-600 hover:text-gray-500" href="#">Contact</a></li>
    </ul>
    ...
    <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
        <div class="flex items-center mb-8">
            ...
            <button class="navbar-close">
                <svg class="h-6 w-6 text-gray-600 cursor-pointer hover:text-gray-500" xmlns="http://www.w3.org/2000/svg"
        ...
        <div>
            <ul>
                <li class="mb-1">
                    <a class="block p-4 text-sm font-semibold text-gray-600 hover:bg-blue-50 hover:text-blue-600 rounded"
                        href="#">Home</a>
                </li>
                <li class="mb-1">
                    <a class="block p-4 text-sm font-semibold text-gray-600 hover:bg-blue-50 hover:text-blue-600 rounded"
        ...
        <div class="mt-auto">
            ...
            <p class="my-4 text-xs text-center text-gray-600">
